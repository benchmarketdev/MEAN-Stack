    ...
    <div id="wrapper"><!--BEGIN TOPBAR-->
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" class="navbar navbar-default navbar-static-top">
            <div class="navbar-header">
                ...
                <a id="logo" href="{{route('addNewSchool')}}" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text" style="font-size:25px !important;">SchoolMangement</span></a></div>
        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active">
                        <a href="{{route('addNewSchool')}}">
                            <i class="fa fa-bookmark fa-fw"></i>
                            <span class="menu-title">Add new school</span>
                            <span class="fa arrow"></span>
                        </a>
                    </li>

                    <li class="active">
                        <a href="{{route('savenewdata')}}">
                            <i class="fa fa-edit fa-fw"></i>
                            <span class="menu-title">Save new data</span>
                            <span class="fa arrow"></span>
                        </a>
                    </li>
